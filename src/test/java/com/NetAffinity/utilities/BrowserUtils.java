package com.NetAffinity.utilities;
...
*/
    ...
    public static void verifyElementDisplayed(By by) {
        try {
            Assert.assertEquals("Element not visible: " + by, Driver.getDriver().findElement(by).isDisplayed());
    ...
    public static void verifyElementNotDisplayed(By by) {
        try {
            Assert.assertEquals("Element should not be visible: " + by, Driver.getDriver().findElement(by).isDisplayed());
        } catch (NoSuchElementException e) {
            e.printStackTrace();
